                ...
                success: function(msg) {
                    ...
                    setTimeout(() => {
                        ...
                        if (rowInTable2) {
                            ...
                            const selectedDescrProd = rowInTable2.getAttribute('data-descrprod');
                            ...
                            if (rowInTable1) {
                                ...
                                rowInTable1.cells[4].textContent = selectedCodProd;
                                rowInTable1.cells[5].textContent = selectedRef;
                                rowInTable1.cells[6].textContent = selectedDescrProd;
