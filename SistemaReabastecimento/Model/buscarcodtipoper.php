...
$tsqlTipoper = "SELECT CODTIPOPER, AD_PEDIDOECOMMERCE, AD_GARANTIAVERIFICADA FROM TGFCAB WHERE NUNOTA = $request AND (STATUSNOTA <> 'L' OR NUNOTA IN (3960452, 3960456, 3960448, 4158514, 4158424, 4984493))";
