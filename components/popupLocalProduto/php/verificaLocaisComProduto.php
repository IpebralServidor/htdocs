...
$tsql = "DECLARE @CODPROD INT = (SELECT DISTINCT TGFPRO.CODPROD 
        ...
        WITH LocalProdutos AS (
            SELECT CODLOCAL, ESTOQUE, CONTROLE, ISNULL(AD_DT_ULT_MOV, GETDATE()) AS DTNEG
            FROM TGFEST 
        ...
        ORDER BY CODLOCAL";
        // Trecho do select que mostra os locais onde o item passou no último ano, retirado por Assis a pedido do Geraldo no dia 12/06/2025
        // UNION
