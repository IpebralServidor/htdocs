<?php
    echo '   
        <div class="modal fade" id="modalDeleteProd" tabindex="-1" role="dialog" aria-labelledby="modalDeleteProd" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body fw-bold">
                        Deseja excluir o item: <span id="prodDelete"></span>?
                    </div>
