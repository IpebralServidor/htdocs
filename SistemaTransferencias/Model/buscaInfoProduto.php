...
$tsqlInfos = "    SELECT ROUND(TGFPEM.ESTMIN,2),
                        ISNULL((SELECT SUM(ISNULL(ESTOQUE - RESERVADO, 0)) FROM TGFEST EST WHERE CODLOCAL = TGFCAB.AD_PARAMETROS_REABAST AND EST.CODPROD = TGFPRO.CODPROD AND EST.CODEMP = TGFCAB.CODEMP AND EST.CODPARC = 0), 0), 
