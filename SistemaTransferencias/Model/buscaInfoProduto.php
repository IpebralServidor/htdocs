...
$tsqlInfos = "    SELECT ROUND(TGFPEM.ESTMIN,2),
                        (SELECT SUM(ISNULL(ESTOQUE - RESERVADO, 0)) FROM TGFEST EST WHERE CODLOCAL = TGFPEM.CODLOCALPAD AND EST.CODPROD = TGFPRO.CODPROD AND EST.CODEMP = TGFCAB.CODEMP AND EST.CODPARC = 0), 
