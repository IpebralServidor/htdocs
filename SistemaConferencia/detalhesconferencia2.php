...
<html>
	...
	<body class="body-detalhes" onload="scrollToRow(<?php echo $linhamarcada; ?>)">
		...
		<div>
			...
			<button name="conferir" id="conferir" type="submit">Conferir</button>
		...
		<div id="container">
			<div id="ItensConferencia">
				<div>
					<h4>Itens em Conferência</h4>
					<button onclick="confirmar_conf();">Finalizar Conferência</button>
					<button onclick="abrirdivergencias();">Produtos Divergentes</button>
				...
				<div id="popupconf" class="popupconf">
					...
					<div>
						Qtd. Volume: <input type="text" name="qtdvol" id="qtdvol">
						Volume: <input type="text" name="volume" id="volume">
						Peso Bruto: <input type="text" minlength="1" name="pesobruto" id="pesobruto">
						Observação: <textarea id="observacao" cols="20" rows="20" name="observacao"><?php echo $OBSERVACAO; ?></textarea>

						<button name="confirmar" id="confirmar" type="submit" value="Confirmar"></button>
				...
				<div id="popupdivergencias" class="popupdivergencias">
					<h6>Produtos com Divergência</h6>
					<div>
						<table>
							<tr>
								<th>Referência</th>
				...
				<div id="popuppendencias" class="popuppendencias">
					<h4>Produtos com Pendências</h4>
					<form name="bulk_action_form" action="inserependencia.php" method="post" onSubmit="return insere_pendencia();">
						<div>
							<table>
								<tr>
								...
								<tr>
									<td><input type="checkbox" name="id[<?php echo "$row2[0]/$nunota2"; ?>]" class="checkbox"/></td>
									<td><?php echo $row2[0]; ?></td>
									<td><?php echo $row2[1]; ?></td>
									<td><?php echo $row2[2]; ?></td>
									<td><?php echo $row2[3]; ?></td>
				...
				<div id="popupconfdivergencia" class="popupconfdivergencia">
					<h4>Conferência finalizada como divergente!</h4>
					<button onclick="" >Realizar recontagem</button>
					<button onclick="fecharconfdivergencia(); abrirconf();">Concluir</button>
				</div>
				...
				<div id="popupconfdivcorte" class="popupconfdivcorte">
					...
					<form method="post">
						<button type="submit" name="btn-recontagem">Realizar Recontagem</button>
					</form>

					<div>
						<button name="btn-corte" onclick="fecharconfdivcorte(); abrirconf();">Cortar Itens Divergentes</button>
					</div>

					<button onclick="fecharconfdivcorte(); abrirconf();">Concluir</button>
				...
				<form name="bulk_action_form" action="action.php" method="post" onSubmit="return delete_confirm();"/>
					<div id="itensconferidos">
						...
						?>
							...
							<tr >
								<td>
									<input type="checkbox" name="id[<?php echo "$row2[3]/$nunota2"; ?>]" class="checkbox"/>
								</td>
								<td><?php echo $row2[0]; ?></td>
								<td><?php echo $row2[1]; ?></td>
								<td><?php echo $row2[2]; ?></td>
					...
					<div>
						<button type="submit" name="bulk_delete_submit">Apagar Item(ns) Selecionado(s)</button>
					</div>
				</form>
