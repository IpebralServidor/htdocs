						...
						<table width="800" border="1px" bordercolor="white" style="margin-top: 5px; " id="table">
							<tr>
								<font size="-1" face="Arial, Helvetica, sans-serif">
									<th width="20%">
										<font face="Arial, Helvetica, sans-serif">Referência</font>
									</th>
									<th width="40%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Descr. Produto</font>
									</th>
									<th width="20%" align="center">
										<font face="Arial, Helvetica, sans-serif">Qtd. Mistura.</font>
									</th>
									<th width="20%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Cód. Mát. Prima</font>
									</th>
							</tr>
							<?php
							...
							<tr>
								<font size="-1" face="Arial, Helvetica, sans-serif">
									<th width="5%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Emp.</font>
									</th>
									<th width="7%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Disponível</font>
									</th>
									<th width="5%" align="center">
										<font face="Arial, Helvetica, sans-serif">Estoque</font>
									</th>
									<th width="7%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Reservado</font>
									</th>
									<th width="7%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Cód. Local</font>
									</th>
									<th width="20%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Desc. Local</font>
									</th>
									<th width="7%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Controle</font>
									</th>
									<th width="7%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Dt. Val.</font>
									</th>
									<th width="10%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Tipo</font>
									</th>
									<th width="25%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Cód. Barra</font>
									</th>
							</tr>
							<?php
							$tsql2 = " 	SELECT CODEMP,
					...
					<article>
						<table width="700" border="1px" bordercolor="white" style="margin-top: 5px;  text-align: center;" id="table">
							<tr>
								<font size="-1" face="Arial, Helvetica, sans-serif">
									<th width="16.66%">
										<font face="Arial, Helvetica, sans-serif">Preço</font>
									</th>
									<th width="16.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Tabela</font>
									</th>
									<th width="16.66%" align="center">
										<font face="Arial, Helvetica, sans-serif">Nome Tab.</font>
									</th>
									<th width="16.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Qtd. Máx. Loc.</font>
									</th>
									<th width="16.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Média Vendas</font>
									</th>
									<th width="16.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Promoção?</font>
									</th>
							</tr>
							<?php
						...
						<table width="2500" border="1px" bordercolor="white" style="margin-top: 5px;" id="table">
							<tr>
								<font size="-1" face="Arial, Helvetica, sans-serif">
									...
									<th width="6.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Nro. Nota</font>
									</th>
									<th width="6.66%" align="center">
										<font face="Arial, Helvetica, sans-serif">Cód. Empresa</font>
									</th>
									<th width="6.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Qtd. Neg.</font>
									</th>
									<th width="6.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Dt. Neg.</font>
									</th>
									<th width="6.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Controle</font>
									</th>
									<th width="6.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Cód. Parceiro</font>
									</th>
									<th width="6.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Nome Parceiro</font>
									</th>
									<th width="6.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Cód. Vendedor</font>
									</th>
									<th width="6.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Nome Vendedor</font>
									</th>
									<th width="6.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">TOP</font>
									</th>
									<th width="6.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Descr. TOP</font>
									</th>
									<th width="6.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Dt. Prev. Entrega</font>
									</th>
									<th width="6.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Tipo de Pedido</font>
									</th>
									<th width="6.66%" style="text-align: center;">
										<font face="Arial, Helvetica, sans-serif">Descr. Tip. Pedido</font>
									</th>
							</tr>
							<?php
