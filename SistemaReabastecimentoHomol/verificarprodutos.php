...
$tsqlCont = "   SELECT COUNT(*) 
                    FROM TGFITE 
                    WHERE NUNOTA = $nunota2
                      AND SEQUENCIA > 0";
$stmtCont = sqlsrv_query( $conn, $tsqlCont);
$rowCont = sqlsrv_fetch_array( $stmtCont, SQLSRV_FETCH_NUMERIC);
...
<body onload=" encerrarAtividade(<?php echo $nunota2; ?>) ">
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div>
                <p>Quantidade de itens: <?php echo $rowCont[0] ?></p>
            </div>
            ...
            <div class="d-flex justify-content-center">
                <table class="table">
                    <tr> 
                        ...
                        <th>Local</th>
                        <th>Qtde</th>
                        <?php if($rowEhTransf[0]  == 'TRANSFPRODSAIDA') {?>
                            <th>
                                <button class="btnEntregaPegaTudo" data-toggle="modal" data-target="#entregaModal">Entregar </button>
                            </th>
                        <?php }?>

                        <?php if($rowEhTransf[0]  == 'TRANSFPRODENTRADA') {?>
                            <th>
                                <button class="btnEntregaPegaTudo" data-toggle="modal" data-target="#pegaModal">Pegar</button>
                            </th>
                        <?php } else {?>
                            <th></th>
                        <?php }?>
