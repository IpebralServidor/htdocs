...
<title>::APPS ipebral - Página Inicial</title>
...
<table align="center">
  ...
  <tr><h1 align="center" style="color:#0000FF" class="alert-heading">
    Consulta de estoque por local </tr>
</table>
<br />
<br />
<table align="center" cellspacing="2">
  ...
  <tr>
    <td width="116"><label><span class="style1">Digite a referencia</span></label></td>
    <td width="127" colspan="2"> (<a href="http://zxing.appspot.com/scan?ret=http://10.0.0.23:81/ipebral/conexaosql5.php?referencia={CODE}">Leitor</a>):
	
      <?php if (isset($_POST['codigo'])) 
{ ?>
      <td>
      <input type="text" name="codigo" value="<?= $_GET['codigo'] ?>" /></td>
        <input name="" type="submit" class="btn btn-inverse" value="Pesquisar" /></td>
    </tr>
    <?php
			 }
 ?>
