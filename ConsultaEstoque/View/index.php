		...
		<div class="screen">
			<form action="consulta.php" method="post" class="margin-top35" style="width: 80%;">
				<div class="form-group">
					<label for="referencia" class="label-input">Referência ou Código de Barra:</label>
					<input type="text" class="form-control margin-top10" id="referencia" name="REFERENCIA" required>
				</div>

				<button type="submit" name="pesquisar" class="btn btn-primary btn-form margin-top35">Pesquisar</button>
			</form>
		</div>
	</div>
</body>
